...
public class PmsBrandController {
    ...
    public CommonResult<CommonPage<PmsBrand>> listPmsBrandControllers(PmsBrand record, Integer pageSize, Integer pageNum) {
        List<PmsBrand> list = service.getPmsBrands(record, pageSize, pageNum);
